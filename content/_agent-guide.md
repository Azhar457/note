...
- The **body content** of the notes can be written in a **mixed Indonesian-English (ID-EN) language** according to the user's preference. Keep technical terms in their original English form (e.g., _key encapsulation_, _tiling_, _circuit breaker_).
