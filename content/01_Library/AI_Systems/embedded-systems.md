...
> [!info] Cara Baca
> Keduanya bertemu di satu titik: **bare-metal access ke hardware tanpa abstraksi OS**. Flash forensics adalah embedded RE yang diterapkan ke storage device. Gunakan bersama [[hardware-hacking-re|Hardware Hacking]] untuk gambaran lengkap.
...
- [[hpa-exorcism|SOP HPA Exorcism]] — Flash forensics tingkat HDD

---

_Embedded Systems & Flash Forensics | Dari LED Blink sampai Chip-Off NAND · Bare-Metal World_
