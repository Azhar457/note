...
> [!info] Prasyarat
> Pastikan sudah paham [[computer-science-foundations|OS Internals]] (CPU Ring, kernel module, syscall) dan [[hierarchy-operating-systems|Hierarki OS]] (Level 0–8). eBPF beroperasi di Ring 0, bahkan bisa menyentuh Ring -1 (hypervisor) lewat ekstensi modern.
...
- [[computer-science-foundations|Computer Architecture]] — CPU Ring, Intel ME, hypervisor
- [[hierarchy-operating-systems|Hierarki OS]] — posisi eBPF di setiap level OS
- [[ids-ips-waf-nsm-comparison|IDS/IPS/WAF Comparison]] — Falco dan Cilium dalam konteks stack security
- [[purple-team-osi-killchain|Purple Team Kill-Chain]] — eBPF sebagai detection layer
- [[cryptography-biometrics|Kriptografi Post-Quantum]] — ML-DSA untuk future eBPF signing
