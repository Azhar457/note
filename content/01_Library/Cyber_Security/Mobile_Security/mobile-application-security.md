---
title: "Mobile Application Security — Deep Dive: Android Pentesting, iOS Security, OWASP MASVS, Reverse Engineering APK/IPA"
tags:
  - mobile-security
  - android
  - ios
...
> Nota ini melengkapi [[web-hacking-exploitation]] (web app pentesting) dan [[browser-security-exploitation-deepdive]] (browser security) dengan **mobile-specific attack surface**. Juga terkait dengan [[mobile-forensics]] (data forensik device — beda scope), [[api-security-deep-dive]] (mobile API security — sebagian besar mobile app backend-nya API), [[identity-and-access-management]] (mobile auth — OAuth, JWT), [[cryptography-biometrics]] (mobile crypto — Keychain, Keystore, Secure Enclave), dan [[endpoint-detection-playbook]] (mobile endpoint — EDR untuk mobile).
