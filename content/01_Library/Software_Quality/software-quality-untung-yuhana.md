...
- **SQA** (Software Quality Assurance) — proses, sistemik, *preventif*
...
**Perbedaan:**
- **Verifikasi:** "Are we building the product *right*?" — proses, spec, standard
- **Validasi:** "Are we building the *right* product?" — kebutuhan user, domain
...
> **Kunci:** All about *process mindset* — dokumentasi, review, ukur, improve. Bukan soal tool mewah.
