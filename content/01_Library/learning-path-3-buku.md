...
- [ ] **SQAP untuk pengembangan sistem**  
      _Bug: tidak ada dokumentasi_ → fix: buat dokumentasi yang lengkap
- [ ] **V&V untuk pengujian sistem**  
      _Bug: tidak ada pengujian_ → fix: lakukan pengujian yang lengkap
...
- [ ] **Mikrotik untuk jaringan**  
      _Bug: tidak ada konfigurasi_ → fix: lakukan konfigurasi yang lengkap
- [ ] **PLTS untuk listrik**  
      _Bug: tidak ada perencanaan_ → fix: lakukan perencanaan yang lengkap
