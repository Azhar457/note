...
> Dokumen ini adalah **lapisan pertahanan terpadu** untuk menghadapi setiap alat di Military & Intelligence Tools Hierarchy. Setiap lapisan sesuai dengan level ancaman (0–6) dan mencakup tindakan teknis, prosedural, serta kebijakan. Tidak ada satu lapisan yang sempurna; prinsip **defense-in-depth** adalah kunci.
...
Dokumen ini adalah ringkasan defensif dari seluruh alat di Military & Intelligence Tools Hierarchy:
...
- [[Verint]], [[PRISM]], [[UPSTREAM & TEMPORA]] — COMSEC
- [[XKEYSCORE]], [[ICREACH]], [[Palantir Gotham]] — Policy & advocacy
- [[Dual-Use Spectrum & Ethical Framework]] — Panduan etis penggunaan alat
