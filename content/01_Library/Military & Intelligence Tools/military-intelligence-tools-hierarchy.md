...
```
Military & Intelligence Tools/
├── 📄 Military & Intelligence Tools Hub.md         ← yg sekarang, di-strip jadi ringkasan + navigasi
...
│   ├── Palantir Gotham.md
│   └── ICREACH.md
├── 📄 Dual-Use Spectrum & Ethical Framework.md
...
_Military & Intelligence Tools Hierarchy | Shadow Arsenal Level 0–6 | Dual-Use Knowledge Base_
