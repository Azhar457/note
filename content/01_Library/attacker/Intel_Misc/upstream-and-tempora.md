...
- MacAskill, E., Borger, J., Hopkins, N., Davies, N., & Ball, J. (2013). *GCHQ Taps Fibre-Optic Cables for Secret Access to World's Communications* (The Guardian).
...
- UK Parliament. *Privacy and Security: A Modern and Transparent Legal Framework* (2015).
- EFF. *NSA Spying on Americans: How the NSA's Domestic Surveillance Programs Work*.
