...
> [!info] Prasyarat
> Pastikan sudah paham [[computer-science-foundations|OS Internals]] (CPU Ring, kernel module, syscall) dan [[OS_HIERARCHY|Hierarki OS]] (Level 0–8). eBPF beroperasi di Ring 0, bahkan bisa menyentuh Ring -1 (hypervisor) lewat ekstensi modern.
...
>
> Ini nyambung langsung ke: [[KRIPTOGRAFI_BIOMETRIK|Kriptografi Post-Quantum]] + [[OS_HIERARCHY|OS Hierarki Level 7-8]] + [[FONDASI_CS|Computer Architecture Ring -2]]. Belum ada yang publish paper tentang kombinasi ini.
...
- [[FONDASI_CS|Computer Architecture]] — CPU Ring, Intel ME, hypervisor
- [[OS_HIERARCHY|Hierarki OS]] — posisi eBPF di setiap level OS
- [[IDS_IPS_WAF_NSM_COMPARISON|IDS/IPS/WAF Comparison]] — Falco dan Cilium dalam konteks stack security
- [[PURPLE_TEAM_OSI_KILLCHAIN|Purple Team Kill-Chain]] — eBPF sebagai detection layer
- [[KRIPTOGRAFI_BIOMETRIK|Kriptografi Post-Quantum]] — ML-DSA untuk future eBPF signing
- [[EMBEDDED_SYSTEMS|Embedded Systems]] — eBPF on RISC-V untuk IoT
- [[index|Master Index]]
