...
```html
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,700;1,400&family=Spectral:ital,wght@0,300;0,400;1,300&display=swap" rel="stylesheet">
```
```css
...
```html
<link href="https://fonts.googleapis.com/css2?family=Marcellus+SC&family=Jost:ital,wght@0,300;0,400;0,500;1,300&display=swap" rel="stylesheet">
```
```css
...
.hd-defined { animation: hd-pulse 3s ease-in-out infinite; }
.hd-chart   { animation: hd-reveal 0.6s ease-out forwards; }
```
