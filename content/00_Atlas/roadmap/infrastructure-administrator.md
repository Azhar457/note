...
*Credit where it's due. These are real skills, not beginner level.*
...
*Target: 2 weeks | 1hr/day = ~14 sessions | 4-5hr day = 2-3 sessions*
...
### ✅ Phase 1 Checkpoint
> *Can you rebuild a basic server config (user + package + service) with one command?*  
...
*Target: 2 weeks | Focus: making playbooks smart, not just sequential*
...
> *- Installs Docker on Rocky Linux*  
> *- Only restarts Docker daemon if config changed*  
> *- Skips installation if Docker already exists*  
...
*Target: 2 weeks | Focus: reusable, structured automation*
...
### ✅ Phase 3 Checkpoint
> *Single command rebuilds your Docker stack on a fresh Rocky Linux VM.*  
...
*Target: 2 weeks | Focus: production-grade practices*
...
### ✅ Phase 4 Checkpoint
> *Your playbooks:*  
> *- Use templates for all config files*  
> *- Have zero plaintext passwords*  
> *- Handle failure without crashing the entire run*

---

## Phase 5 — Real Project

*Target: 2 weeks | This is the proof of everything*
...
### ✅ Final Checkpoint
> *Time it. Fresh VM → full stack running.*  
> *Target: under 15 minutes.*  
> *Can you explain every role to someone who's never used Ansible?*  
...
*Part of [[00_Atlas/roadmap]] — Infrastructure Administrator path*
