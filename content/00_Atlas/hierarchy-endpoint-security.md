...
> Konsep inti hierarki ini adalah **inversi paradoks**: privilege naik, visibility defender turun. Ring 3 gampang dideteksi (antivirus regular cukup). Ring -3 _mustahil_ dideteksi dari software alone. Inilah kenapa target pemerintah & korporasi besar butuh hardware attestation (TPM, HSM) — software-only defense mandek di Ring 0.
...
_Endpoint Security Hierarchy | Ring 3 (Aplikasi) → Ring -3 (Sub-Firmware Selalu ON) · Inversi Privilege-Visibility_
