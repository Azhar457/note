...
- **[Dokumen 2]** Security Tools Language Analysis — _akan dibuat_
- [[EBPF_KERNEL_SECURITY|eBPF Security]] — Rust (Aya) + C untuk kernel-level program
- [[FONDASI_CS|Computer Architecture]] — Assembly dan register sebagai fondasi
- [[PLATFORM_TECHNOLOGIES_OVERVIEW|Platform Technologies]] — Rust di WASM, Go di cloud
- [[PURPLE_TEAM_OSI_KILLCHAIN|Purple Team]] — tool yang ditulis dalam bahasa mana
- [[index|Master Index]]

---

_Hierarki Bahasa Pemrograman | Machine Code → Assembly → C → Rust → Go → Python → DSL · Silicon sampai Cloud_
